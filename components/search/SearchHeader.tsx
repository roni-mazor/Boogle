...
export default function SearchHeader() {
    ...
    return (
        <header className=" sticky top-0  bg-white ">
            <div className="flex flex-wrap sm:flex-nowrap items-center px-6 mb-6  sm:m-0">

                <Image
                    style={{ objectFit: 'cover' }} className="m-auto sm:m-0 cursor-pointer" alt="google logo" width="170" onClick={() => { router.push('/') }}
